                ...
                <div class="tab-content" id="modifSinMovTabContent">
                    ...
                    <div class="tab-pane fade" id="tab-documento-content" role="tabpanel">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Tamaño máximo: <strong>200 MB</strong></div>
...
function subirDocumentoReemplazar() {
    ...
    if (file.size > maxSize) {
        ...
        alert(`El archivo es demasiado grande (${sizeMB} MB). Máximo permitido: 200 MB`);
        return;
    }
...
function mostrarInfoArchivo(input) {
    ...
    if (file.size > MAX_FILE_SIZE) {
        html = `<div class="alert alert-danger alert-dismissible fade show mb-0" role="alert">
            ...
            <small>${file.name} (${sizeMB} MB) supera el límite de 200 MB</small>`;
...
document.querySelector('#modalCargar form').addEventListener('submit', function(e) {
    ...
    if (file.size > MAX_FILE_SIZE) {
        alert('El archivo es demasiado grande. Máximo permitido: 200 MB');
        return false;
    }
