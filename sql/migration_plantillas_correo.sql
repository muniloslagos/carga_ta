...
INSERT INTO `plantillas_correo` (`tipo`, `asunto`, `cuerpo`, `variables_disponibles`, `activo`, `envio_automatico`) VALUES
('fin_proceso_cargadores', 'Resumen de Carga - {mes_carga} {ano_carga}', '<h2>Estimado/a {nombre_usuario},</h2>\n\n<p>Se ha finalizado el <strong>proceso de carga de información</strong> correspondiente al período <strong>{mes_carga} {ano_carga}</strong>.</p>\n\n<p>A continuación se detalla el estado de sus ítems asignados:</p>\n\n<h3>Estado de Carga:</h3>\n{resumen_carga}\n\n<p><strong>Fecha límite del plazo:</strong> {fecha_limite}</p>\n\n<p>Si tiene documentos pendientes, por favor regularice su situación a la brevedad.</p>\n\n<p>Saludos cordiales,<br>\n<strong>Municipalidad de Los Lagos</strong></p>', '{"nombre_usuario": "Nombre completo del usuario", "mes_carga": "Nombre del mes de carga", "ano_carga": "Año de carga", "resumen_carga": "Resumen HTML del estado de carga con documentos cargados, fechas y pendientes", "fecha_limite": "Fecha límite formateada"}', 1, 0);
